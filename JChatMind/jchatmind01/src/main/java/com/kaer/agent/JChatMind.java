...
public class JChatMind {
    ...
    // 可用的技能列表（启动时从 skills 文件夹扫描）
    private List<SkillMeta> availableSkills;
    // 工具调用管理器
...
//    private String childChatSessionId;
    ...
    /**
     * 将可用技能列表格式化为人类可读字符串，供 System prompt 使用。
     */
    private String formatSkillList(List<SkillMeta> skills) {
